...
namespace Meshcapade
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Meshcapade.AutoSDKRetryOptions Retry { get; set; } = new global::Meshcapade.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Meshcapade.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Meshcapade.IAutoSDKHook>();
        ...
        public global::Meshcapade.AutoSDKClientOptions AddHook(
            global::Meshcapade.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Meshcapade.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Meshcapade.AutoSDKClientOptions UseAuthorizationProvider(
            global::Meshcapade.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Meshcapade.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Meshcapade.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Meshcapade.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Meshcapade.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Meshcapade.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Meshcapade.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Meshcapade.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Meshcapade.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Meshcapade.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Meshcapade.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Meshcapade.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Meshcapade.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Meshcapade.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Meshcapade.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Meshcapade.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Meshcapade.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Meshcapade.AutoSDKClientOptions clientOptions,
            global::Meshcapade.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Meshcapade.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Meshcapade.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Meshcapade.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Meshcapade.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Meshcapade.IAutoSDKHook, global::Meshcapade.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Meshcapade.AutoSDKHookContext context)
        {
